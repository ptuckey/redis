...
foreach redis_bulk_cmd {
    set setnx rpush lpush rpushx lpushx linsert lset lrem sadd srem sismember echo getset smove zadd zaddnx zaddcmp zrem zscore zincrby append zrank zrevrank hget hdel hexists setex
} {
